...
cd src
C:\uasm32\uasm32.exe -Sp1 -Zp1 -zlf -zlp -zls -coff main.asm dinput8.asm util.asm cfg.asm init.asm getmod.asm getproc.asm fps.asm camera.asm d3d.asm d3dsc.asm d3ddev.asm d3dctx.asm
