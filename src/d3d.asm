...
sc_present		dd ?,8,Present		; Original address, offset in VTable, hook
...
D3D11CreateDeviceAndSwapChain proc
	...
	; For some godforsaken reason, Nep exe has internal table of redirecting jumps between normal code and external API
	mov eax, nepbase
	add eax, 398FACh
	call eax
