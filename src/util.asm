...
nepwnd_fail	db "Couldn't find Nep window",0
nepwnd_sig	db "VII [REV: 345]",0
buf			dd ?
GetNepWindow proc
	push eax
...
get_nep_window_loop:
	...
	call findwnd
	test eax, eax
	jz get_nep_window_fail
	mov nepwnd, eax
	push 1024
	push buf
	push nepwnd
	call getwndtext
	push offset nepwnd_sig
	push buf
	call strstr
	add esp, 8
	test eax, eax
	jz get_nep_window_loop
	push buf
	push nepwnd
	call getclrect
	mov eax, buf
